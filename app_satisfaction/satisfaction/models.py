...
class Feedback(models.Model):
    ...
    score_calendar = models.IntegerField(null=True, blank=True)
    comment_calendar = models.TextField(null=True, blank=True)

    score_contacts = models.IntegerField(null=True, blank=True)
    comment_contacts = models.TextField(null=True, blank=True)

    score_tasks = models.IntegerField(null=True, blank=True)
    comment_tasks = models.TextField(null=True, blank=True)

    score_notes = models.IntegerField(null=True, blank=True)
